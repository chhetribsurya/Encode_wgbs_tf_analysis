...
output_dir = os.path.expanduser("~/for_chris/batch_I/motifs_methplot_total")
...
meme_file_path = "/gpfs/gpfs1/home/schhetri/for_chris/batch_I/chip_motif_analysis_total/IDR*/MeMe/*.txt"
